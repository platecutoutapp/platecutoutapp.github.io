ToDo:
- Berücksichtigung der Schnittfuge ("Sägeblattstärke", Default 3mm, konfigurierbar)
- PDF-Generierung als Export (PDF mit dem Schnittplan)
- Combobox "Guillotine-Schnitt" oder "Freies verschachteln" (Default: Freies verschachteln. Guillotine-Schnitt lässt nur Schnitte von Kante zu Kante zu (für Plattensägen).)
